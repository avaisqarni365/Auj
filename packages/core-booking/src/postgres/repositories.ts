...
class PgBookingRepository implements BookingRepository {
  ...
  async save(b: Booking): Promise<Booking> {
    ...
    try {
      ...
      await client.query(
        `INSERT INTO bookings (id, customer_id, channel, mode, status, pilgrim_ids, hold_id, hold_expires_at, booking_ref, visa_case_id, rawdah, gift, special_requests, refund_amount, refund_currency, created_at, updated_at)
         VALUES ($1,$2,$3,$4,$5,$6::jsonb,$7,$8,$9,$10,$11::jsonb,$12::jsonb,$13::jsonb,$14,$15,$16,$17)
         ON CONFLICT (id) DO UPDATE SET customer_id=$2, channel=$3, mode=$4, status=$5, pilgrim_ids=$6::jsonb, hold_id=$7, hold_expires_at=$8, booking_ref=$9, visa_case_id=$10, rawdah=$11::jsonb, gift=$12::jsonb, special_requests=$13::jsonb, refund_amount=$14, refund_currency=$15, updated_at=$17`,
        [b.id, b.customerId, b.channel, b.mode ?? null, b.status, JSON.stringify(b.pilgrimIds), b.holdId ?? null, b.holdExpiresAt ?? null, b.bookingRef ?? null, b.visaCaseId ?? null, b.rawdah ? JSON.stringify(b.rawdah) : null, b.gift ? JSON.stringify(b.gift) : null, b.specialRequests ? JSON.stringify(b.specialRequests) : null, b.refund?.amount ?? null, b.refund?.currency ?? null, b.createdAt, b.updatedAt],
      );
