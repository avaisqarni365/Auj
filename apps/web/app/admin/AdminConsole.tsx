    ...
    <div className="flex min-h-screen bg-sand-50 text-sand-ink">
      ...
      <main className="min-w-0 flex-1">
        <header className="sticky top-0 z-30 flex items-center gap-3.5 border-b border-sand-200 bg-sand-50/90 px-[clamp(16px,3vw,36px)] py-3.5 backdrop-blur">
          ...
          <Link href="/admin/catalog" className="whitespace-nowrap rounded-[10px] border-[1.5px] border-green-700 bg-green-50 px-3.5 py-2.5 text-sm font-semibold text-green-800 hover:bg-green-100 sm:inline">🧩 Wizards &amp; content</Link>
